...
$Alms = llamadoDeAPI("GET", "http://127.0.0.1//Proyecto_Cloudware_v2/almacen/controlador_almacen/REST_almacen.php", NULL);
...
foreach ($almacenes as $fila) {
    if ($fila["id_localidad_almacen"] === $locacion) {
        ...
        $L = llamadoDeAPI("PUT", "http://127.0.0.1//Proyecto_Cloudware_v2/almacen/controlador_almacen/REST_lotes.php", $var);
        ...
        foreach ($_POST["paquetes"] as $fila) {
            ...
            $P = llamadoDeAPI("POST", "http://127.0.0.1//Proyecto_Cloudware_v2/almacen/controlador_almacen/REST_paquetes.php", $pack);
        }
